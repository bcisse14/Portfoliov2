  ...
  nav: { home: "Accueil", services: "Services", portfolio: "Portfolio", about: "À propos", contact: "Contact" },
    ...
    projects: [
      ...
      },
      {
        ...
        need: "Automatiser la prospection commerciale en ciblant des départements précis",
        solution: "Site d'automatisation pour la prospection avec recherche automatique de sites selon le ou les départements sélectionnés, afin de trouver des prospects qualifiés plus rapidement.",
      ...
      },
      {
        ...
        need: "Structurer mes journées avec des objectifs clairs à accomplir chaque jour",
        solution: "Plateforme de discipline quotidienne avec des objectifs chaque jour, un système d'XP pour chaque action validée et une progression par niveaux pour rester motivé dans la durée.",
